            ...
            <div className="flex-1 flex flex-col px-6 lg:px-10 py-6 overflow-y-auto">
              ...
              {premiereResults.length > 0 && (
                <>
                  ...
                  >
                    <p className="font-bebas text-[12px] tracking-[0.25em] whitespace-nowrap" style={{ color: "rgba(201,168,76,0.85)" }}>
                      OPENING NIGHT PREMIERES
                    </p>
                    <div className="h-px flex-1" style={{ background: "linear-gradient(to right, rgba(195,170,90,0.20), transparent)" }} />
                  </motion.div>
          ...
          {premiereResults.length > 0 && (
            <>
              <div className="flex items-center gap-3 mb-4">
                <p className="font-bebas text-[11px] tracking-[0.25em] whitespace-nowrap" style={{ color: "rgba(201,168,76,0.85)" }}>
                  OPENING NIGHT PREMIERES
                </p>
                <div className="h-px flex-1" style={{ background: "linear-gradient(to right, rgba(195,170,90,0.20), transparent)" }} />
              </div>
